...
cat_pipeline = Pipeline([
    ...
    ('onehot', OneHotEncoder(sparse=False, handle_unknown='ignore'))  # FIXED HERE
])
...
#model_selected.compile(optimizer=keras.optimizers.Adam(learning_rate=0.001), loss='mse')
...
#model_all.compile(optimizer=keras.optimizers.Adam(learning_rate=0.001), loss='mse')
